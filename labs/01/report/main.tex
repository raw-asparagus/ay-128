...
\begin{figure*}[b]
  \centering
  \includegraphics[width=0.7\textwidth]{figures/fig_methods_corner_rrab.pdf}
...
\begin{figure*}[t]
  \centering
  \includegraphics[width=0.7\textwidth]{figures/fig_methods_corner_rrc.pdf}
  \caption{Overlay corner plot comparing all three MCMC methods for \textbf{RRc}: M-H (blue), NUTS+Potential (orange), native PyMC (green). The RRc posteriors are broader than RRab (fewer stars), but all three methods converge to consistent posteriors.}
