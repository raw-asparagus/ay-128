...
\begin{enumerate}
  ...
  \item $E(G_{\rm BP}-G_{\rm RP}) \geq 0$ mag (exclude unphysical negative reddening): removes 38,571 stars (14.3\%), primarily low-latitude stars with negative empirical reddening
\end{enumerate}
